...
<button class="tablinks" onclick="window.location.href='Radiographer.php'" >RIS</button>
 ...
 <input type="hidden" name="SearchFilter" class="input-group-text" id="Search1">
    ...
    <table border="2px" style="width: 100%; border-collapse: collapse;">
      <tr>
        ...
        <?php
  $Searching1 = "SELECT * FROM study WHERE (Status = 'Start Exam' OR Status = 'Started' OR Status = 'Processing' OR Status = 'QC' OR Status = 'QC Pending') AND ACCESSION LIKE '%$var2%'";
  $SearchingResults1=mysqli_query($con,$Searching1);
