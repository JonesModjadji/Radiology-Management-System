...
$var2 = ob_get_clean();
        ...
        $Searching1 = "SELECT * FROM study,$var WHERE study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' AND $var.Branch LIKE '%$var2%'
       ...
       $Searching2 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' AND $var.Branch LIKE '%$var2%'
		AND (study.Status ='$STATUS1s' OR study.Status ='$STATUS2' OR study.Status ='$STATUS3' OR study.Status ='$STATUS4' 
		OR study.Status ='$STATUS5' OR study.Status ='$STATUS6' OR study.Status ='$STATUS7' OR study.Status ='$STATUS8' 
		OR study.Status ='$STATUS9' OR study.Status ='$STATUS10' OR study.Status ='$STATUS11' OR study.Status ='$STATUS12'))";
		
		$Searching3 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' AND $var.Branch LIKE '%$var2%'
		...
		$Searching4 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' AND $var.Branch LIKE '%$var2%'
		AND ($var.Name='$NAMEFILTER' AND $var.Surname='$SURNAMEFILTER') AND '$STATUS1s'='' )";
		
		$Searching5 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' 
		...
		$Searching6 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting' 
		AND ($var.Name='$NAMEFILTER' AND $var.Surname='$SURNAMEFILTER') AND '$STATUS1s'='$var2' )";
		
		$Searching7 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Waiting'AND ($var.Branch='$STATUS1s' OR $var.Branch='$STATUS2' OR $var.Branch='$STATUS3'
		 OR $var.Branch='$STATUS4' OR $var.Branch='$STATUS5' OR $var.Branch='$STATUS6' OR $var.Branch='$STATUS7'
		  OR $var.Branch='$STATUS8' OR $var.Branch='$STATUS9' OR $var.Branch='$STATUS10' OR $var.Branch='$STATUS11'
		  OR $var.Branch='$STATUS12' OR $var.Branch='$STATUS13'
		 OR $var.Branch='$STATUS14' OR $var.Branch='$STATUS15' OR $var.Branch='$STATUS16' OR $var.Branch='$STATUS17'
...
$var2 = ob_get_clean();
        ...
        $Searching1 = "SELECT * FROM study,$var WHERE study.SESSIONID=$var.SESSIONID AND study.Status !='Waiting' AND $var.Branch='$var2'
		AND (study.Status ='$STATUS1s' OR study.Status ='$STATUS2' OR study.Status ='$STATUS3' OR study.Status ='$STATUS4' 
		OR study.Status ='$STATUS5' OR study.Status ='$STATUS6' OR study.Status ='$STATUS7' OR study.Status ='$STATUS8' 
		OR study.Status ='$STATUS9' OR study.Status ='$STATUS10' OR study.Status ='$STATUS11' OR study.Status ='$STATUS12')AND( 
		$var.Name='$NAMEFILTER' OR $var.Surname='$SURNAMEFILTER' OR study.AssignedRadiographer ='$PHYSICIAN' 
		OR study.AssignedRadiologist ='$PHYSICIAN' OR $var.Branch='$STATUS1s' OR $var.Branch='$STATUS2' OR $var.Branch='$STATUS3'
		 OR $var.Branch='$STATUS4' OR $var.Branch='$STATUS5' OR $var.Branch='$STATUS6' OR $var.Branch='$STATUS7'
		  OR $var.Branch='$STATUS8' OR $var.Branch='$STATUS9' OR $var.Branch='$STATUS10' OR $var.Branch='$STATUS11'
		  OR $var.Branch='$STATUS12' OR $var.Branch='$STATUS13'
		 OR $var.Branch='$STATUS14' OR $var.Branch='$STATUS15' OR $var.Branch='$STATUS16' OR $var.Branch='$STATUS17'
		  OR $var.Branch='$STATUS18' OR $var.Branch='$STATUS19' OR $var.Branch='$STATUS20' OR $var.Branch='$STATUS21'
		   OR $var.Branch='$STATUS22'  OR $var.MRN='$MRNFILTER' 
		OR study.Accession='$SFILTER' ) ";
		
       $Searching2 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status !='Waiting' AND $var.Branch='$var2'
		AND (study.Status ='$STATUS1s' OR study.Status ='$STATUS2' OR study.Status ='$STATUS3' OR study.Status ='$STATUS4' 
		OR study.Status ='$STATUS5' OR study.Status ='$STATUS6' OR study.Status ='$STATUS7' OR study.Status ='$STATUS8' 
		OR study.Status ='$STATUS9' OR study.Status ='$STATUS10' OR study.Status ='$STATUS11' OR study.Status ='$STATUS12'))";
		
		$Searching3 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status !='Waiting' AND $var.Branch='$var2'
		AND ($var.Name='$NAMEFILTER' OR $var.Surname='$SURNAMEFILTER' OR study.AssignedRadiographer ='$PHYSICIAN' 
		OR study.AssignedRadiologist ='$PHYSICIAN'  OR $var.MRN='$MRNFILTER' 
		OR study.Accession='$SFILTER' OR study.ExamDate BETWEEN '$FROMFILTER' AND '$TOFILTER' ))";
		
		$Searching4 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status !='Waiting' AND $var.Branch='$var2'
		AND ($var.Name='$NAMEFILTER' AND $var.Surname='$SURNAMEFILTER') AND '$STATUS1s'='' )";
  ...
  while ($rows1=mysqli_fetch_array($SearchingResults7) ) {
	...
	$SESSIONID1 = $rows1['SESSIONID'];
     ...
     <tr>
		...
		style="text-decoration:none;color: red;">'.$SURNAME1.'</a></td>
        <td style="text-align: center;color:white;">'.$PATIENTSPROCEDURE1.'</td>
        <td style="text-align: center;color:white;">'.$STATUS1.'</td></tr>
    ';
