...
<button class="tablinks" onclick="window.location.href='Typist.php'" >RIS</button>
...
<div class="hover">
 ...
 <input type="hidden" name="SearchFilter" class="input-group-text" id="Search1">
    ...
    <table border="1px" style="width: 100%;">
      ...
      <?php
  $Searching1 = "SELECT * FROM study WHERE Status = 'Dictated' AND ACCESSION LIKE '%$var2%'";
  $SearchingResults1=mysqli_query($con,$Searching1);
	...
	$SEX = $rows2['Sex'];
     echo '
	  <tr>
        ...
        <td style="text-align: center;color:white;"><a style="text-decoration:none;color:'.$CANCELLED.';" href="Typist1.php?ID='.$PATIENTSID.'&ACC='.$ACCESSION.'">'.$STATUS.'</a></td>
      </tr>
    ';
