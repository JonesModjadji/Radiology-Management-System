...
$var = ob_get_clean();
       ...
       header("location: SearchedFilterTypist.php?MRN=$MRNFILTER&S=$SFILTER&NAME=$NAMEFILTER&SURNAME=$SURNAMEFILTER&PHYSICIAN=$PHYSICIAN&FROM=$FROMFILTER&TO=$TOFILTER".http_build_query($STATUS));
	   }
   }}
?>
<!doctype html>
...
<button class="tablinks" onclick="window.open('Typist.php');" >RIS</button>
...
<table>
 ...
 <input type="hidden" name="SearchFilter" class="input-group-text" id="Search1">
	  ...
	  <td>
	  <div class="hover">
 <button class="input-group-text" onclick="window.open('Typist.php');" style="color: white;"><i class="fa fa-times"></i> CLEAR</button>
 </div>
	  </td>
	  </tr>
	  </table>
    ...
    <table border="1px" style="width: 100%;">
       <tr>
        ...
        <td style="text-align: center;color: red;">ASSIGNED TO</td>
...
$var2 = ob_get_clean();
                ...
                $Searching1 = "SELECT * FROM study,$var WHERE study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated' AND $var.Branch LIKE '%$var2%'
       ...
       $Searching2 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated' AND $var.Branch LIKE '%$var2%'
		AND (study.Status ='$STATUS1s' OR study.Status ='$STATUS2' OR study.Status ='$STATUS3' OR study.Status ='$STATUS4' 
		OR study.Status ='$STATUS5' OR study.Status ='$STATUS6' OR study.Status ='$STATUS7' OR study.Status ='$STATUS8' 
		OR study.Status ='$STATUS9' OR study.Status ='$STATUS10' OR study.Status ='$STATUS11' OR study.Status ='$STATUS12'))";
		
		$Searching3 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated' AND $var.Branch LIKE '%$var2%'
		...
		$Searching4 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated' AND $var.Branch LIKE '%$var2%'
		AND ($var.Name='$NAMEFILTER' AND $var.Surname='$SURNAMEFILTER') AND '$STATUS1s'='' )";
		
		$Searching5 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated' 
		...
		$Searching6 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND study.Status ='Dictated'
		AND ($var.Name='$NAMEFILTER' AND $var.Surname='$SURNAMEFILTER') AND '$STATUS1s'='$var2' )";
		
		$Searching7 = "SELECT * FROM study,$var WHERE (study.SESSIONID=$var.SESSIONID AND (study.PatientsID=patients.MRN AND study.Status ='Dictated' AND ($var.Branch='$STATUS1s' OR $var.Branch='$STATUS2' OR $var.Branch='$STATUS3'
		 OR $var.Branch='$STATUS4' OR $var.Branch='$STATUS5' OR $var.Branch='$STATUS6' OR $var.Branch='$STATUS7'
		  OR $var.Branch='$STATUS8' OR $var.Branch='$STATUS9' OR $var.Branch='$STATUS10' OR $var.Branch='$STATUS11'
		  OR $var.Branch='$STATUS12' OR $var.Branch='$STATUS13'
		 OR $var.Branch='$STATUS14' OR $var.Branch='$STATUS15' OR $var.Branch='$STATUS16' OR $var.Branch='$STATUS17'
  ...
  while ($rows1=mysqli_fetch_array($SearchingResults3) ) {
	...
	$IDNUMBER = $rows1['IdentityNumber'];
     ...
     <tr>
        ...
        <td style="text-align: center;color:white;">'.$DOCTOR.'</td>
